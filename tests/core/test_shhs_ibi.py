...
import pandas as pd
from pyhealth.datasets.shhs_ibi import SHHSIBIDataset


class TestSHHSIBIPrepareMetadata(unittest.TestCase):
    ...
    def test_generates_metadata_csv(self):
        SHHSIBIDataset.prepare_metadata(self.root)
    ...
    def test_no_matched_pairs_raises(self):
        ...
        with self.assertRaises(FileNotFoundError):
            SHHSIBIDataset.prepare_metadata(empty_root)
...
class TestSHHSIBIDataset(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with patch(
            ...
            self.dataset = SHHSIBIDataset(root=self.root)
    ...
    def test_dataset_loads(self):
        self.assertIsInstance(self.dataset, SHHSIBIDataset)
    ...
    def test_event_attributes(self):
        ...
        events = patient.get_events(event_type="shhs_ibi_sleep")
